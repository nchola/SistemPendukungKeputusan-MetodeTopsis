                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select name="tahun" class="form-control">
                                    @for ($i = 2020; $i < 2040; $i++)
                                        <option {{ $i == old('tahun', date('Y')) ? 'selected' : '' }}
                                            value="{{ $i }}">{{ $i }}
                                        </option>
                                    @endfor
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="id_pegawai" class="form-control">
                                    @foreach ($pegawai as $item)
                                        <option {{ $item->id == old('id_pegawai') ? 'selected' : '' }}
                                ...
                                <tr>
                                    @foreach ($kriteria as $item)
                                        <td>
                                            ...
                                            {{-- <input type="number" name="nilai[]" placeholder="Input Nilai..."
                                                class="form-control" required min="1" max="5"> --}}
                                        </td>
                                    @endforeach
                                </tr>
                            </tbody>
